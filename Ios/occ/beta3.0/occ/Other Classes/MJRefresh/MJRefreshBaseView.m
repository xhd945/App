...
#define kTextColor [UIColor colorWithRed:0x90/255.0 green:0x90/255.0 blue:0x90/255.0 alpha:1]
...
- (void)initial
{
    ...
    // 2.时间标签
    [self addSubview:_lastUpdateTimeLabel = [self labelWithFontSize:14]];
    
    // 3.状态标签
    [self addSubview:_statusLabel = [self labelWithFontSize:14]];
...
- (void)setFrame:(CGRect)frame
{
    ...
    // 3.箭头
    CGFloat arrowX = 50;
    _arrowImage.frame = CGRectMake(arrowX, statusY, 30.0f, kViewHeight-2*statusY);
