...
- (void)layoutSubviews
{
    ...
    self.nameLabel.frame = CGRectMake(self.leftImageView.frame.origin.x+self.leftImageView.frame.size.width+10, self.leftImageView.frame.origin.y+10, kNameLabelWidth, height);
