...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [arrowImageView setImage:[UIImage imageNamed:@"jiantou_down"]];
        [arrowImageView setHighlightedImage:[UIImage imageNamed:@"jiantou_up"]];
...
-(void)layoutSubviews
{
    ...
    {
        [_arrowImageView setImage:[UIImage imageNamed:@"jiantou_up"]];
    }
    else
    {
        [_arrowImageView setImage:[UIImage imageNamed:@"jiantou_down"]];
    }
}
...
-(void)setData:(NSDictionary*)data
{
    ...
    if ([data objectForKey:@"sender"]!=nil&&[[data objectForKey:@"sender"]isKindOfClass:[NSString class]])
    {
...
+(float)getCellHeight:(NSDictionary*)data
{
    ...
    int height=[CommonMethods heightForString:content andFont:FONT_12 andWidth:(SCREEN_WIDTH-70)];
    return MAX(height+65,80);
}
