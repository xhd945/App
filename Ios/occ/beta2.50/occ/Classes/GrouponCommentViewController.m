...
@interface GrouponCommentViewController ()<MJRefreshBaseViewDelegate>
{
...
- (void)viewDidLoad
{
    ...
    [titleLable setText:[NSString stringWithFormat:@"商品评价"]];
...
{
    GrouponCommentCell *cell = [[GrouponCommentCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"GrouponCommentCellIdentifier"];
...
{
    static NSString * GrouponCommentCellIdentifier = @"GrouponCommentCellIdentifier";
    
    GrouponCommentCell * cell = [tableView dequeueReusableCellWithIdentifier:GrouponCommentCellIdentifier];
    if(!cell)
    {
        cell = [[GrouponCommentCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:GrouponCommentCellIdentifier];
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_HIGH, 0),
                   ^{
                       NSMutableDictionary *obj =[NSMutableDictionary dictionaryWithObjectsAndKeys:
                                                  ...
                                                  [NSNumber numberWithInt:self.grouponId], KEY_ITEMID,
                                                  nil];
