...
- (void)viewDidLoad
{
    ...
    [titleLable setText:[NSString stringWithFormat:@"商品列表"]];
    ...
    //sort===========================================================
    OCCTabbar *tabbarView = [[OCCTabbar alloc] initWithFrame:CGRectMake(10, HEADER_HEIGHT, SCREEN_WIDTH-20, SCREEN_HEIGHT)
                                                 andTitleArr:[NSArray arrayWithObjects:@"人气",@"销量",@"价格",@"搜索", nil]];
    tabbarView.delegate = self;
    [self.view addSubview:tabbarView];
    
    OCCTableView *tableView=[[OCCTableView alloc]init];
    [tableView setFrame:CGRectMake(0,tabbarView.frame.origin.y+tabbarView.frame.size.height+1,SCREEN_WIDTH,SCREEN_HEIGHT-(tabbarView.frame.origin.y+tabbarView.frame.size.height))];
                       ...
                       if (root==nil){
                           ...
                           dispatch_async(dispatch_get_main_queue(),
                                          ^{
                                              ...
                                              int iCount = [[data objectForKey:@"count"] intValue];
