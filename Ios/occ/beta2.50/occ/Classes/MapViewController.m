...
- (void)viewDidLoad
{
    ...
    UIPinchGestureRecognizer *panTap =[[UIPinchGestureRecognizer alloc] initWithTarget:self action:@selector(handlePanTap:)];
    [self.webView addGestureRecognizer:panTap];
    panTap.delegate=self;
    panTap.cancelsTouchesInView =NO;
...
-(void)handlePanTap:(UIPinchGestureRecognizer *)sender
{
